    ...
    def show_instructions(self):
        if self.instructions_menu is None:
            ...
            instructions_text = "Connect 4 is a two-player game played on a grid of 6 rows and 7 columns.\n" \
                                "Players take turns dropping their colored coins into any of the columns.\n" \
                                "Once a coin is dropped into a column, it occupies the lowest available empty slot\n" \
                                "in that column.\n" \
                                "Discs always fall straight down and stack on top of each other.\n" \
                                "The game continues until one player successfully connects four coins or \n" \
